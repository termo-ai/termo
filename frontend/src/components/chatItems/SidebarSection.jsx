      ...
      <div className="p-4 grow">
        ...
        <div className="mt-4 flex flex-col gap-1">
          {chats.map((chat) => (
            <div
              key={chat.id}
              className={`flex items-center justify-between px-4 py-2 text-gray-300 ${
                activeChat === chat.id ? "bg-gray-500/50" : "bg-gray-800"
              } rounded-lg group hover:bg-gray-500/50 transition`}
